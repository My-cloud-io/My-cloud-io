...
// 4 MiB keeps each browser request below common Vercel function body limits.
// The complete file is stored as many durable Telegram MTProto messages.
const CHUNK_SIZE = 4 * 1024 * 1024;
const MAX_FILE_SIZE = Number(process.env.MAX_FILE_SIZE || 1024 * 1024 * 1024 * 1024);
const MAX_CHUNKS = 300000;
...
// Vercel loads this Express app as a serverless Node function. Local/other
// Node deployments can still use `node server.js` normally.
